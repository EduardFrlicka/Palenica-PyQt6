...
class Ui_CustomerHandler(object):
    def setupUi(self, CustomerHandler):
        ...
        self.label_manual_customer = QtWidgets.QLabel(parent=CustomerHandler)
        self.label_manual_customer.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_manual_customer.sizePolicy().hasHeightForWidth())
        self.label_manual_customer.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(17)
        font.setBold(True)
        self.label_manual_customer.setFont(font)
        self.label_manual_customer.setObjectName("label_manual_customer")
        self.verticalLayout.addWidget(self.label_manual_customer)
...
"zákazníka"))
        ...
        self.label_manual_customer.setText(_translate("CustomerHandler", "Zákazník zadaný manuálne, dáta nebudu uložené do databázy. Len tlač."))
